			...
			<?php
		    	...
		    	foreach ($annonces as $item) {
		    		...
		    		echo "<tr>";
			    		...
			    		echo "<td><form action='action-form/delete.php' method='post'><input type='hidden' name='AnnonceId' value='".$item->id."'/><input type='submit' value='Supprimer'/><input type='button' value='Modifier'/></form></td>";
		    		echo "</tr>";
		    	}
		    ?>
		</table>
