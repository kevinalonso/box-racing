 ...
 */
if (!class_exists('wpsearchconsole_display_post_duplicate_content_metabox')) {

    class wpsearchconsole_display_post_duplicate_content_metabox
    {
        ...
        public function __construct()
        {
            ...
            <a href="<?php echo wpsearchconsole::getInstance()->filtering_url->render_url_with_newquery("mitambo-api-call=true&focus_tab=3&metabox=mitambo-$type-duplicate-content#tab3"); ?>"
